...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="../chat/index.php"><i class="fas fa-comments"></i><span>Chat</span></a>
      <a href="../mini_projects/all_posts.php"><i class="fas fa-digital-tachograph"></i><span>Rating</span></a>
